...
@section('content')
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb mb-0" style="font-size: 0.875rem; font-weight: 500;">
            ...
            <li class="breadcrumb-item active text-primary" aria-current="page">Update Progress</li>
        </ol>
    </nav>
    ...
    <div class="row g-4">
        <div class="col-12 col-xl-8 d-flex flex-column gap-4">
            ...
            <form action="{{ route('aspirasi.store') }}" method="POST" enctype="multipart/form-data" id="myForm">
                @csrf
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <label class="form-label fw-semibold" style="font-size: 0.875rem; color: #111418;">Status
                                    Update</label>
                                <select class="form-select border-0 bg-light shadow-none"
                                    style="height: 44px; font-size: 0.875rem;" name="status">
                                    <option value="menunggu" {{ $aspirasi->status == 'menunggu' ? 'selected' : '' }}>
                                        Menunggu</option>
                                    <option value="proses" {{ $aspirasi->status == 'proses' ? 'selected' : '' }}>Proses
                                    </option>
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-semibold" for="editor"
                                style="font-size: 0.875rem; color: #111418;">Feedback / Description</label>
                            <input type="hidden" name="deskripsi" id="deskripsi">
                            <div class="border rounded-3 overflow-hidden" id="editor" style="height: 200px;"></div>
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-semibold" style="font-size: 0.875rem; color: #111418;">Progress
                                Photo</label>
                            <input type="file" name="foto"
                                class="form-control border-0 bg-light shadow-none @error('foto') is-invalid @enderror">
                            <div class="form-text text-secondary" style="font-size: 0.75rem;">Maksimal file: 10MB (JPG,
                                PNG)</div>
                            @error('foto')
                        ...
                        <div class="d-flex justify-content-end gap-2 pt-4 border-top">
                            <a class="btn btn-light fw-bold px-4" href="{{ route('aspirasi.index') }}"
                                style="font-size: 0.875rem;">Cancel</a>
                            <button class="btn btn-primary fw-bold px-4 shadow-sm" type="submit"
                                style="font-size: 0.875rem;">Save Changes</button>
                        </div>
                    </div>
                </div>
            </form>
                            ...
                            <div class="position-relative ps-5 mb-4">
                                ...
                                <div class="d-flex flex-column gap-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="text-secondary fw-medium text-uppercase"
